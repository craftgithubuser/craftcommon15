...
2.      -- inside Address table add column 
        ...
        -Cust_Stree              - String	      didn't accept null value
...
4. Write a query that perform INNER JOIN, LEFT OUTER JOIN, Right outer join and FULL OUTER JOIN.

*/
use mydb;
create table Address(
Cust_ZIP varchar(50) not null ,
Cust_Stree varchar(50) not null,
...
insert into Address(Cust_ZIP, Cust_Stree, Cust_city ,Cust_State,Cust_ID )
